...
${receiptSystemPrompt}`;
  ...
  const effectiveIsTransferReceipt = Boolean(
    isTransferReceipt
    || (expectedAccountMatched && rawAmountWon && transferDate)
  );
